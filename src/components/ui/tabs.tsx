...
const tabsListVariants = cva(
  "ui:group/tabs-list ui:inline-flex ui:w-fit ui:items-center ui:justify-center ui:rounded-[10px] ui:p-[3px] ui:text-muted-foreground ui:group-data-[orientation=horizontal]/tabs:h-9 ui:group-data-[orientation=vertical]/tabs:h-fit ui:group-data-[orientation=vertical]/tabs:flex-col ui:data-[variant=line]:rounded-none",
  {
    variants: {
      variant: {
        default: "ui:bg-muted",
