...
export default function OnboardingScreen() {
  ...
  return (
    <View className="flex-1 bg-bg">
      <ScrollView
        contentContainerStyle={{ paddingTop: insets.top + 24, paddingBottom: insets.bottom + 120, paddingHorizontal: 28 }}
        keyboardShouldPersistTaps="handled"
      >
        <Text className="text-gold-bright text-[11px] font-bold tracking-[2px] uppercase mb-2">Onboarding</Text>
        <Text className="text-ink text-4xl font-bold mb-1">Set up your operation</Text>
        <Text className="text-ink-muted text-sm mb-8">A couple of details and your command center is ready.</Text>

        <Text className="text-ink-muted text-[11px] font-bold tracking-wider uppercase mb-2">Company name</Text>
        <TextInput
          value={companyName}
          onChangeText={setCompanyName}
          placeholder="Your company name"
          placeholderTextColor="rgba(242,237,228,0.4)"
          className="bg-surface border border-[rgba(255,240,210,0.12)] rounded-xl px-4 py-3 text-ink mb-7"
        />

        <Text className="text-ink-muted text-[11px] font-bold tracking-wider uppercase mb-1">Trades</Text>
        ...
        <Text className="text-ink-muted text-[11px] font-bold tracking-wider uppercase mb-1 mt-7">Location</Text>
      ...
      <View
        className="absolute left-0 right-0 bottom-0 px-7 pt-3 bg-bg border-t border-[rgba(255,240,210,0.08)]"
      ...
      >
        ...
        >
          {busy
            ...
            : <Text className="text-[#1A120A] text-base font-bold">Enter command center</Text>}
        </Pressable>
      </View>
    </View>
  )
