...
const lines = [
  ...
  '## Result',
  '',
  'Phases A through D are implemented and committed. The Home dashboard and lead to cash workflow are covered on desktop and mobile. The RLS migration is committed but has not been applied to production.',
  '',
  '## Replacement Counts',
  '',
